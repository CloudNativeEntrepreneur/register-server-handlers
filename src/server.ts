...
export const registerHandlerRoute = (
  server,
  handler,
  serverPath = "/",
  handlerOptions = {}
  ...
  server.post(
    `${serverPath}${handler.type}`,
    wrapInputInCloudEventThenHandle(handler, handlerOptions)
  );
};

export const wrapInputInCloudEventThenHandle =
